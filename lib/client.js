...
Client.prototype.connect = function () {
    ...
    zk.once('init', function (broker) {
        ...
        for (var b in broker) {
            /**
             * broker[b].host = (os.platform.toLowerCase().indexOf('win') !== -1  && broker[b].host === '0.0.0.0') ? '127.0.0.1' : broker[b].host ;
             * Adding this change to make this module to work on windows and vagrant. Vagrant setup has this
             * requirement to resolve to host 0.0.0.0 for forwarded ports. Windows don't work with node.js's net module
             * and if host is 0.0.0.0
             * @type {string}
             */
